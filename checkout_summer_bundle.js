...
class CheckOutWebflow {
	...
	_ensureCustomSelectStyles() {
		...
		style.textContent =
			...
			'.custom-select-option.custom-select-option-create{cursor:pointer;transition:background-color 0.15s ease;margin-top:10px;border-top:1px solid #e0e0e0;padding-top:10px;}' +
			'.custom-select-option.custom-select-option-create:hover{background-color:#efe3e4;box-shadow:0 1px 4px rgba(0,0,0,0.15);}';
